...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Widget build(BuildContext context) {
    final reports = MockStore.instance.submitted;
    final filtered = _filter == 'All'
        ? reports
        : reports.where((_) => _filter == 'final').toList();
  ...
  Widget _buildReportCard(Assignment a) {
    return InkWell(
      borderRadius: BorderRadius.circular(16),
      onTap: () => Navigator.of(context).push(MaterialPageRoute(
          builder: (_) => ReportViewerScreen(assignment: a))),
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(16),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '📅 ${a.dueDate.day}/${a.dueDate.month}/${a.dueDate.year}    ${a.templateName}${a.findings > 0 ? '    ${a.findings} findings' : ''}',
                    style: const TextStyle(
